...
<div class="d-flex flex-column align-items-center mt-3">
    ...
    <div class="caption mt-2" style="max-width: 100%; text-align: center;">
        Figure 3: Sequential Funnels for motion planning <d-cite key="tedrake2010lqr"></d-cite>.
    </div>
</div>
...
<div class="d-flex flex-column align-items-center mt-3">
    ...
    <div class="caption mt-2" style="max-width: 100%; text-align: center;">
        Figure 4: (a) Plane Deviation from nominal trajectory (b) "Funnel" of possible trajectories <d-cite key="majumdar2017funnellibrariesrealtimerobust"></d-cite>.
    </div>
</div>
...
QP-CBF-CLF for safe trajectory optimization has many applications such as automatic cruise control and lane keeping, dynamic walking, etc <d-cite key="ames2019control"></d-cite>.
