...
Control Barrier functions (CBFs) can be thought of as the transpose of Control Lyapunov functions (CLFs). While CLFs focus on the stability of dynamical systems, CBFs focus on the safety aspect. 