...
For example, in <d-cite key="pmlr-v164-dawson22a"></d-cite>, the lyapunov is initialized randomly and the controller network is initialized witht the LQR solution. The loss function is defined as follows:
