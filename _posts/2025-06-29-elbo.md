...
>> The blog post is based primarily on the excellent overview paper by Calvin Luo, for detailed treatment of proofs and implementation check out his paper <d-cite key="luo2022understandingdiffusionmodelsunified"></d-cite>.
...
- To explicitly control the data we generate through some information $y$ (ex: text, or low res image), we also need to learn the conditional distribution $p(x \mid y)$. This forms the backbone of image-text models and super-resolution models.
