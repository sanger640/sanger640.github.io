...
=
\begin{bmatrix}
-\dfrac{c_{af} + c_{ar}}{um} & \dfrac{-a c_{af} + b c_{ar}}{u I_{z}} \\
\dfrac{a c_{af} - b c_{ar}}{um} + u & -\dfrac{a^2 c_{af} + b^2 c_{ar}}{u I_{z}}
\end{bmatrix}
\begin{bmatrix}
v \\
r
