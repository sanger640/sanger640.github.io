...
## Strategies
- Pointers Going in the same direction: removing dupes, middle of a linked list (speed), move zeros to the end
- Opp direction: Valid Palindrome, Two Sum sorted
- Sliding windows: keep track of a value in a local window
  - Fixed:
  ```cpp
